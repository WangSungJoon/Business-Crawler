...
예의 있는 말투로 다음 내용을 포함하는 짧은 코멘트를 작성해.
- K-Bot 이름을 언급한 자기 소개 한 문장
- 문장이 끝나면 줄바꿈.
- 이 이메일은 AI경영분석에서 제작된 AI기반 자동화 수집 프로그램으로 수집됨.
- 오늘은 <span style="color:#6968EC;font-weight:bold;">{new_articles_num}개</span> 새로운 공고가 수집됨.
{keywords_prompt}
- 마지막에는 하루를 응원하는 한 줄 코멘트.
"""
